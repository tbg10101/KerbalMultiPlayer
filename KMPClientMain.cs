...
namespace KMP
{
    class KMPClientMain
    {
        ...
        static void handleConnection()
        {
            try
            {
                while (true)
                {
                    ...
                    if (stopwatch.ElapsedMilliseconds - lastTCPMessageSendTime >= KEEPALIVE_DELAY && stopwatch.ElapsedMilliseconds - lastTCPKeepaliveTime >= KEEPALIVE_DELAY)
					{
                        lastTCPKeepaliveTime = stopwatch.ElapsedMilliseconds;
                    ...
                    while (receivedMessageQueue.Count > 0)
                    {
                        ...
                        if (stopwatch.ElapsedMilliseconds > receiveMaxTimer) {
        ...
        private static void sendProbeMessage()
        {
